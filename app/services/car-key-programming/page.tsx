...
export const metadata: Metadata = {
    title: 'Car Key Programming Manchester | Mobile Fob Coding',
    description: `Need a car key programmed? We offer mobile key programming for remotes, fobs, and smart keys in Manchester. Code keys bought online or new spares. Call ${SITE_CONFIG.phoneDisplay}.`,
};
                ...
                <main>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <p className="text-xl md:text-2xl mb-8 text-gray-200">
                                    Did you buy a key online and need it paired to your car? We bring our diagnostic tablets to you.
                                </p>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto border-l-4 border-[hsl(25,100%,50%)] pl-6">
                                <h2 className="text-2xl font-bold mb-4 text-[hsl(220,68%,18%)]">
                                    Mobile Coding Experts
                                </h2>
                                <p className="text-lg text-gray-700 font-medium">
                                    **KEY 2 BHP AUTO LOCKSMITH LTD** offers a standalone programming service. Whether your battery died and your fob lost memory, or you need a spare programmed, we sync your keys to the vehicle's central electronics module (BCM) on-site.
                                </p>
                            </div>
                        </div>
                    </section>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="grid md:grid-cols-2 gap-6">
                                    {[
                                        'Online Keys: We can attempt to program keys you bought elsewhere (no warranty on part).',
                                        'Smart Keys: We program proximity "Push to Start" fobs.',
                                        'Remote Resync: Fixing fobs that have "forgotten" the car.',
                                        'ECU Matching: Pairing new engine ECUs to immobilizers.',
                                        'Multiple Keys: Discount for programming 2 or 3 keys at once.',
                                    ].map((benefit, index) => (
                            ...
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="space-y-8">
                                    {[
                                        {
                                            title: 'Connect',
                                            desc: 'We hook up our diagnostic tool to the OBD port.',
                                        },
                                        {
                                            title: 'Access',
                                            desc: 'We bypass the security gateway.',
                                        },
                                        {
                                            title: 'Learning',
                                            desc: 'We put the car into "Learning Mode."',
                                        },
                                        {
                                            title: 'Cycle',
                                            desc: 'We cycle the ignition with each key to be added.',
                                        },
                                        {
                                            title: 'Exit',
                                            desc: 'We close the learning session and test all buttons.',
                                        },
                                    ].map((step, index) => (
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto">
                                ...
                                <div className="space-y-6">
                                    {[
                                        {
                                            q: 'Can you program a focused eBay key?',
                                            a: 'We can try! But be warned, many cheap online keys have the wrong chip type.',
                                        },
                                        {
                                            q: 'How long does coding take?',
                                            a: 'Usually 10-15 minutes once we are connected.',
                                        },
                                        {
                                            q: 'Why did my key stop working?',
                                            a: 'Sometimes a flat battery causes the rolling code to go out of sync.',
                                        },
                                        {
                                            q: 'Do you cover Audis?',
                                            a: 'Yes, we have specialist VAG equipment.',
                                        },
                                        {
                                            q: 'Can you delete old keys?',
                                            a: 'Yes, indispensable if you bought a second-hand car with only 1 key.',
                                        },
                                    ].map((faq, index) => (
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-3xl mx-auto text-center">
                                ...
                                <p className="text-xl mb-8 text-gray-200">
                                    Let the experts code it correctly.
                                </p>
                                <a
                                    href={`tel:${SITE_CONFIG.phone}`}
                                    className="inline-flex items-center gap-2 bg-[hsl(25,100%,50%)] hover:bg-[hsl(25,100%,45%)] text-white px-8 py-4 rounded-lg font-bold text-lg transition-all shadow-lg hover:shadow-xl"
                                ...
                                <p className="mt-4 text-sm opacity-80">Fast Mobile Service.</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="py-8 bg-gray-100">
                        <div className="container mx-auto px-4 text-center">
                            ...
                            <Link href="/services/remote-key-fob" className="text-blue-600 hover:underline mx-2">Remote Key Fob Replacement</Link> |
