...
export const metadata: Metadata = {
    title: 'Vauxhall Locksmith Manchester | Key Programming & Replacement',
    description: `Vauxhall key specialists. Astra, Corsa, Insignia key programming. HU100 keys, immobiliser reset. Call ${SITE_CONFIG.phoneDisplay}.`,
};

export default function VauxhallLocksmithPage() {
    return (
        <>
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <p className="text-xl md:text-2xl mb-8 text-gray-200">
                                    Vauxhall key programming. Astra, Corsa, Insignia, Zafira. HU100 key cutting, immobiliser coding across Manchester.
                                </p>
                                <a
