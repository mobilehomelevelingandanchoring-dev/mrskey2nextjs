...
export const metadata: Metadata = {
    title: 'Auto Locksmith Didsbury | East & West Didsbury Car Key Service',
    description: `Didsbury auto locksmith. East Didsbury, West Didsbury, M20. Emergency car locksmith, key replacement. Call ${SITE_CONFIG.phoneDisplay}.`,
};
                        ...
                        <div className="container mx-auto px-4">
                            <div className="max-w-4xl mx-auto text-center">
                                ...
                                <p className="text-xl md:text-2xl mb-8 text-gray-200">
                                    Emergency car locksmith serving East Didsbury, West Didsbury, and M20 postcode. 24/7 mobile service.
                                </p>
                                <a
